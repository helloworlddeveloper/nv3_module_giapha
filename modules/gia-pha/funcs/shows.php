...
{
    global $array_data, $global_config, $module_file, $module_info;
    ...
    foreach ($_dirlist as $_dir)
    {
        if ($_dir['relationships'] == 1)
        {
            ...
            $xtpl = new XTemplate("genealogy_show.tpl", NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/" . $module_file);
...
if (defined('NV_IS_USER'))
{
    ...
    $array_mod_title[] = array('title' => $page_title, 'link' => NV_BASE_SITEURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=shows&gid=".$gid);
