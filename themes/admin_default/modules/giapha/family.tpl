...
<table summary="" class="tab1">
	<caption>{LANG.add_family}</caption>
	<tbody>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<img src="{NV_BASE_SITEURL}images/refresh.png" width="16" style="cursor: pointer; vertical-align: middle;" onclick="get_alias('family', {fid});" alt="" height="16" />
			</td>
		</tr>
	</tbody>
	<tbody class="second">
